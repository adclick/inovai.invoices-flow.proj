          ...
          <div className="space-y-1 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span>{job.invoice_reference || "-"}</span>
						...
						<div className="flex justify-between">
							<span className="text-slate-600 dark:text-slate-400">{t("jobs.invoice")}:</span>
							<span><a href={job.documents[0]} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 hover:bg-blue-50 dark:text-blue-500 dark:hover:bg-blue-950/20">{job.documents[0] || "-"}</a></span>
						</div>
          </div>
        </div>
