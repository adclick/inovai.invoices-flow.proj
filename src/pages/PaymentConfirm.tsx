...
import { AlertTriangle, BanknoteIcon, Calendar, CheckCircle, DollarSign, File } from "lucide-react";
					...
					<CardContent className="space-y-6">
						<div className="space-y-4">
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								...
								<div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-md flex items-start">
									<div>
										<span className="text-xs font-medium text-slate-500 dark:text-slate-400">Invoice</span>
										<p className="font-medium text-slate-900 dark:text-white mt-1 truncate max-w-[300px]">
