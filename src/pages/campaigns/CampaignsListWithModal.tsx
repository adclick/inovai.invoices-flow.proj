              ...
              <Table>
                ...
                <TableBody>
                  {paginatedData.map((campaign) => (
                    <TableRow key={campaign.id} className="cursor-pointer" onClick={() => handleEditClick(campaign.id)}>
...
export default CampaignsListWithModal;
